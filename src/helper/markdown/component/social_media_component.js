        ...
        let socialMediaArray = [
            {
                ...
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/raw/master/public/images/icons/facebook.svg`,
            },
            {
                site: `Facebook Messenger`,
                shareUrl: `https://www.facebook.com/dialog/${facebookMessengerPost}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/raw/master/public/images/icons/facebook_messenger.svg`,
            },
            {
                site: `Twitter`,
                shareUrl: `https://twitter.com/intent/${twitterPost}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/raw/master/public/images/icons/twitter.svg`
            },
            {
                site: `WhatsApp`,
                shareUrl: `https://web.whatsapp.com/${whatsAppPost}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/top-github-users-action/master/public/images/icons/whatsapp.svg`
            },
            {
                site: `Telegram`,
                shareUrl: `https://t.me/share/${telegramPost}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/blob/master/public/images/icons/telegram.svg`
            },
            {
                site: `LinkedIn`,
                shareUrl: `https://www.linkedin.com/${linkedInPost}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/blob/master/public/images/icons/linkedin.svg`
            },
            {
                site: `Vkontakte`,
                shareUrl: `https://vk.com/${vkontaktePost}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/blob/master/public/images/icons/vkontakte.svg`,
            },
            {
                site: `Blogger`,
                shareUrl: `https://www.blogger.com/${bloggerPost}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/blob/master/public/images/icons/blogger.svg`,
            },
            {
                site: `Wordpress`,
                shareUrl: `https://wordpress.com/wp-admin/${wordpressPost}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/blob/master/public/images/icons/wordpress.svg`,
            },
            {
                site: `Email`,
                shareUrl: `mailto:recipient ${email}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/blob/master/public/images/icons/gmail.svg`
            },
            {
                site: `Reddit`,
                shareUrl: `https://www.reddit.com/${redditPost}`,
                iconUrl: `https://raw.githubusercontent.com/gayanvoice/github-active-users-monitor/blob/master/public/images/icons/reddit.svg`,
            }
        ];
        let table = `<table>\n`;
        table = table + `\t<tr>\n`;
